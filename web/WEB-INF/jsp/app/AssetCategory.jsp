...
var departmentJsonData = '<%=objDepartment.toString()%>';
	...
	<link rel="stylesheet" type="text/css" href="/enterprise-app/js/app/assetcategory/assetcategory.css" />
	<!-- Utils -->
	...
	<!-- View -->
	<script type="text/javascript" src="/enterprise-app/js/app/assetcategory/AssetCategoryGrid.js"></script>
	<!-- Entry point -->
	<script type="text/javascript" src="/enterprise-app/js/app/assetcategory/assetcategory.js"></script>
</head>
<body>
    <div id="assetCategoryPanel"></div>
</body>
</html>
