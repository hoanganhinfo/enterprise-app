...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Injection Regrind rate</title>
...
var departmentJsonData = '<%=objDepartment.toString()%>';
	...
	<link rel="stylesheet" type="text/css" href="/enterprise-app/js/app/injection/RegrindRates/regrindrate.css" />
	...
	<!-- Model -->
	<script type="text/javascript" src="/enterprise-app/js/app/model/RegrindRateMoldel.js"></script>
	
	<!-- View -->
	<script type="text/javascript" src="/enterprise-app/js/app/injection/RegrindRates/RegrindrategGrid.js"></script>
	
	<!-- Entry point -->
	<script type="text/javascript" src="/enterprise-app/js/app/injection/RegrindRates/regrindrate.js"></script>
</head>

<body>
	<div id="RegrindRates"></div>
</body>
</html>
