...
public class AssyParameterController implements Controller, InitializingBean {
	...
	public ModelAndView handleRenderRequest(RenderRequest request,
		...
		System.out.println("load Assy Parameter portlet");
		...
		return new ModelAndView("app/AssyParameter", "param", map);
	}
