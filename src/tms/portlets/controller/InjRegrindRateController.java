...
public class InjRegrindRateController implements Controller, InitializingBean {
	...
	public ModelAndView handleRenderRequest(RenderRequest request,
		...
		System.out.println("load injection regrind rate portlet");
		...
		return new ModelAndView("app/InjectionRegrindRate", "param", map);
	}
