...
public class AssetCategoryController implements Controller, InitializingBean {
	@Autowired
	...
	public ModelAndView handleRenderRequest(RenderRequest request,
		...
		System.out.println("load asset category");
		...
		return new ModelAndView("app/AssetCategory", "param", map);
	}
