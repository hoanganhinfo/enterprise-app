...
public class AssyProductTypeController implements Controller, InitializingBean {
	...
	public ModelAndView handleRenderRequest(RenderRequest request,
		...
		System.out.println("load Assy Product Type portlet");
		...
		return new ModelAndView("app/AssyProductModel", "param", map);
	}
