...
public class CourierShipmentController implements Controller, InitializingBean {
	@Autowired
	...
	public ModelAndView handleRenderRequest(RenderRequest request,
		...
		System.out.println("load courier shipment");
		...
		return new ModelAndView("app/CourierShipment", "param", map);
		}
